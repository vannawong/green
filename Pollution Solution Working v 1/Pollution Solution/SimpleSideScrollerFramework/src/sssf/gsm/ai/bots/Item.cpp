...
*/
Item::Item(	unsigned int initMin, 
...
/*
clone - this method makes another Item object, but does
...
Bot* Item::clone()
{
	Item *botClone = new Item(	minCyclesBeforeThinking, 
...
*/
void Item::initBot(	unsigned int initMin,
						 unsigned int initMax,
						 unsigned int initMaxVelocity)
{
...
*/
void Item::pickRandomCyclesInRange()
{
...
*/
void Item::pickRandomVelocity(Physics *physics)
{
