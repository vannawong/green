...
*/
Attack::Attack(	unsigned int initMin, 
...
/*
clone - this method makes another Attack object, but does
...
Bot* Attack::clone()
{
	Attack *botClone = new Attack(	minCyclesBeforeThinking, 
...
*/
void Attack::initBot(	unsigned int initMin,
						 unsigned int initMax,
						 unsigned int initMaxVelocity)
{
...
*/
void Attack::pickRandomCyclesInRange()
{
...
*/
void Attack::pickRandomVelocity(Physics *physics)
{
