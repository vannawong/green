...
static const string		SPRITE_WIDTH_ELEMENT		= "sprite_width";
static const string		SPRITE_HEIGHT_ELEMENT		= "sprite_height";
static const string		SHEET_WIDTH_ELEMENT			= "width";
static const string		SHEET_HEIGHT_ELEMENT		= "height";
static const string		IMAGES_LIST_ELEMENT			= "images_list";
static const string		IMAGE_FILE_ELEMENT			= "image_file";
static const string		IMAGE_CONFIG				= "image_config";
static const string		SEPARATED					= "SEPARATED";
static const string		SPRITE_OFFSET				= "sprite_offset";
static const string		SPRITE_IMAGE_FILE_NAME		= "sprite_image_file_name";
static const string		SPRITE_SHEET				= "SPRITE_SHEET";
...
private:
	...
	bool loadImageSheet(const TiXmlNode *node, const string fullPath, const string spriteTypeName);
