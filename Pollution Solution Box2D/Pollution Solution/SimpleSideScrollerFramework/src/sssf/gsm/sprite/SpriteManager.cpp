										  ...
										  Viewport *viewport)
{
	...
	if (viewport->areWorldCoordinatesInViewport(	
									b->GetTransform().position.x,
									b->GetTransform().position.y,
									...
									spriteType->getTextureHeight()))
	{
		...
		renderList->addRenderItem(	sprite->getCurrentImageID(),
									(int)floor(0.5f + b->GetTransform().position.x-viewport->getViewportX()),
									(int)floor(0.5f + b->GetTransform().position.y-viewport->getViewportY()),
									(int)floor(),
									sprite->getAlpha(),
									spriteType->getTextureWidth(),
									spriteType->getTextureHeight(),
